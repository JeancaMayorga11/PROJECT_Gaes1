...
<body>
    ...
    <section class="main">
        ...
        <input type="text" class="table__itemAs" value="<?php echo $row["fk_ID_usuario"];?>" name="idusuario">
        <input type="text" class="table__itemAs" value="<?php echo $row["fk_ID_cita"];?>" name="idcita">
        <input type="text" class="table__itemAs" value="<?php echo $row["Descripcion"];?>" name="Descripcion">
