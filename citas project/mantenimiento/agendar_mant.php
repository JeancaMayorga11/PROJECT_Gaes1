        ...
        <div class="contact_form">
            ...
            <p>
                ...
                <p>
                    ...
                    <label for="ciudad" class="tam_1">Seleccione el tipo de mantenimiento</label>
                    </p>
                    <p>
                    <select name="ciudad" id="ciudad" class="tam_2" required="obligatorio">
                ...
                <p>
                    ...
                    <p>
                    <input type="date" name="fecha" id="adress" required="obligatorio" min="<?php echo date('Y-m-d', strtotime('+1 day')); ?>" placeholder="Fecha">
                </p>
                ...
                <p>
                    ...
                    <p>
                    <select name="horario" id="hora" class="tam_3" required="obligatorio">
                
                    <option value="">Seleccione un horario </option>
                    <option value="Horario 1">9:00 a.m</option>
                    <option value="Horario 2">10:00 a.m</option>
                    <option value="Horario 3">11:00 a.m</option>
                    <option value="Horario 4">12:00 p.m</option>
                    <option value="Horario 5">2:00 p.m</option>
                    <option value="Horario 6">3:00 p.m </option>
                    <option value="Horario 7">4:00 p.m</option>
                    <option value="Horario 8">5:00 p.m</option>
                    <option value="Horario 9">6:00 p.m</option>
                    </select>
                </p>
            ...
            <button type="submit"  name="enviar_formulario" id="agendar_cita"><p>Agendar cita</p></button>
            <p class="aviso">
            </p>    
